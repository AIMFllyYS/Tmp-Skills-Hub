...
export const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 rounded-lg text-sm font-medium outline-none transition-[color,background-color,border-color,opacity,transform] duration-[150ms] active:scale-[0.98] motion-reduce:active:scale-100 focus-visible:border-line-strong disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
