...
export const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 rounded-lg text-sm font-medium outline-none transition-colors duration-[150ms] focus-visible:border-line-strong disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
