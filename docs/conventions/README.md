...
- [ui-design-v2.md](./ui-design-v2.md) — UI 设计规范（纸白基底 + 唯一信号色 + 统一组件 + Agent 页呈现规则）；[ui-design-v1.md](./ui-design-v1.md)（UX 铁律、动效类别仍引用）与 [ui-design-v0.md](./ui-design-v0.md) 已取代
